...
| File | Purpose |
| --- | --- |
| `Dockerfile` | Single-container image on **Python 3.12 slim**: builds the frontend, installs deps, bundles Caddy |
...
| `BACKEND_PORT` | no | Internal Reflex backend port (default `8000`) |
